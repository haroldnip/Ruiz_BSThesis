...
def run_simulation(trial_info):
    ...
    stop_folder = os.path.join(base_dir, f"April4_Case_{case}_StopToStop_{stop_to_stop_distance}_Evenly_Spaced_Stops")
...
def run_simulations_for_params(params_file):
    ...
    densities = [0.2, 0.48, 0.8]
    passenger_arrival_rates = [0.3, 1] #[0.3, 1]
    stop_to_stop_distances = [20, 40, 60, 80, 120] 
